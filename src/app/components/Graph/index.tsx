...
import { DataPoints, GraphItemsKeys } from '@/app/visualisation/page';
import { AlgoResult } from '@/lib/prisma/algoRuns';
import Loading from '@/app/visualisation/loading';
...
export const LineChart: React.FC<{
  ...
  return (
    <figure className='relative p-4 pl-8 hover:bg-grey-100'>
      <div className='relative ring-4 ring-inset ring-gray-700 rounded-xl'>
